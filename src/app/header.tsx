  ...
  return (
    <header className="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 w-full md:px-6 max-w-3xl">
      <div className="flex flex-row items-center space-x-3">
        <div className="rounded-full bg-gradient-to-br from-zinc-700/60 to-zinc-500/60 shadow-lg p-[3px] group transform transition ease-out hover:scale-105 hover:from-zinc-700 hover:to-zinc-400 hover:zinc-rose-500/25 active:translate-y-px ring-[5px] ring-zinc-500/10">
          <Image
            width={100}
            height={100}
